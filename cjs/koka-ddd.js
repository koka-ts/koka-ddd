...
var Domain = /** @class */ (function () {
    function Domain(options) {
        ...
        Object.defineProperty(this.$, 'getKey', {
            get: function () { return _this.getKey; },
        });
    }
    return Domain;
}());
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [5 /*yield**/, tslib_1.__values(koka_1.Eff.try(target.call.apply(target, tslib_1.__spreadArray([this], tslib_1.__read(args), false))).catch({
...
var Store = /** @class */ (function () {
    ...
    Store.prototype.runCommand = function (input) {
        ...
        var withRoot = koka_1.Eff.try(command).catch(tslib_1.__assign({ setRoot: this.setState, getRoot: this.getState }, this.context));
        try {
            return koka_1.Eff.runResult(withRoot);
        }
        finally {
