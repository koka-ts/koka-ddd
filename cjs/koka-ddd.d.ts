...
export declare function get<State, Root>(domainOrOptic: Domain<State, Root> | Optic<State, Root>): DomainQuery<State, Root>;
export declare function set<State, Root>(domainOrOptic: Domain<State, Root> | Optic<State, Root>, setStateInput: SetStateInput<State>): DomainCommand<void, Root>;
type KokaClassMethodDecoratorContext<This = unknown, Value extends (this: This, ...args: any) => any = (this: This, ...args: any) => any> = ClassMethodDecoratorContext<This, Value> & {
    /**
...
export declare function query(): <This, Args extends any[], Root, Return, E extends AnyEff>(target: (this: This, ...args: Args) => Generator<Exclude<E, SetRoot<any>>, Return>, context: KokaClassMethodDecoratorContext<This, typeof target>) => typeof target;
export declare function command(): <This, Args extends any[], Root, Return, E extends AnyEff>(target: (this: This, ...args: Args) => Generator<E, Return>, context: KokaClassMethodDecoratorContext<This, typeof target>) => typeof target;
...
export declare class Store<State> {
    ...
    runQuery<T, E extends QueryEff<State> | AnyErr | Async | ToCtxEff<this['context']>>(input: MaybeFunction<Generator<Exclude<E, SetRoot<any>>, T>>): Async extends E ? MaybePromise<Result<T, E>> : Result<T, E>;
    runCommand<T, E extends CommandEff<State> | AnyErr | Async | ToCtxEff<this['context']>>(input: MaybeFunction<Generator<E, T>>): Async extends E ? MaybePromise<Result<T, E>> : Result<T, E>;
}
